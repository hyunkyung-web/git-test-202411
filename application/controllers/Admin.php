...
//         }
	...
	public function contents_list($page=1){
	    ...
	    $viewData = ["menu_num"=>101, "menu_title"=>"Contents List", "schData"=>$schData, "data"=>$query["list"], "totalRecord"=>$totalRecord, "page"=>$page,
	...
	public function contents_form($idx=-1){
	    ...
	    $viewData = ["menu_num"=>102, "menu_title"=>"Contents New", "editMode"=>$editMode, "info"=>$info];	    
	...
	public function template_list($page=1){
	    ...
	    $viewData = ["menu_num"=>201, "menu_title"=>"Template List", "schData"=>$schData, "data"=>$query["list"], "totalRecord"=>$totalRecord, "page"=>$page,
	...
	public function template_form($idx=-1){
	    ...
	    $viewData = ["menu_num"=>202, "menu_title"=>"Template New", "editMode"=>$editMode, "info"=>$info, "idx"=>$idx, "dataProfile"=>$dataProfile, "img_data"=>$img_data];
	...
	public function member_list($page=1){
	    ...
	    $viewData = ["menu_num"=>501, "menu_title"=>"Member List", "schData"=>$schData, "data"=>$query["list"], "totalRecord"=>$totalRecord, "page"=>$page,
	...
	public function member_form($idx=-1){
	    ...
	    $viewData = ["menu_num"=>502, "menu_title"=>"Member New", "editMode"=>$editMode, "info"=>$info];
	...
	public function user_list($page=1){
	    ...
	    $viewData = ["menu_num"=>601, "menu_title"=>"Internal User List", "schData"=>$schData, "data"=>$query["list"], "totalRecord"=>$totalRecord, "page"=>$page,
...
// 	    $idxNo = getPost("idxNo", -1);	    
	    ...
	    $viewData = ["menu_num"=>602, "menu_title"=>"Internal User New", "editMode"=>$editMode, "info"=>$info];
