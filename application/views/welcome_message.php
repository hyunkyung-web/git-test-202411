...
$(function(){
	...
	$("h1").click(function(){
		...
		if( $("#wc-footer").css("display") == "none" ){
			$("#wc-footer").css("display", "block");	
		} else {
			$("#wc-footer").css("display", "none");
		}			    	
	});
...
<body>
	<div id="container">
		...
		<p class="footer" id="wc-footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development') ?  'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?></p>
	</div>
</body>
</html>
